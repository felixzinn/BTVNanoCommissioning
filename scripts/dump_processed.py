...
def dump_lumi(output, fname, year):
    ...
    if year in ["2022", "2023", "2024"]:
        brilcalc_cmd = f"source /cvmfs/cms-bril.cern.ch/cms-lumi-pog/brilws-docker/brilws-env; brilcalc lumi --normtag /cvmfs/cms-bril.cern.ch/cms-lumi-pog/Normtags/normtag_PHYSICS.json -c web -i {fname}_lumi.json -u /pb"
    elif year in ["2025"]:
